...
from network.loss import mse_loss, ssim_loss
...
class Auto_Encoder_single(nn.Module):
    ...
    def train_module(self, x1):
        ...
        # 显式指定 val_range=255.0，因为 out1 和 x1 都是 [0, 255] 范围
        loss_ssim1 = 1 - ssim_loss(out1, x1, normalize=True, val_range=255.0)
